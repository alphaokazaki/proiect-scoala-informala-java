...
public class ApplicationConfiguration {
    ...
    @Bean
    public StocDAO stocDAO() {
        return new JDBCStocDAO(dbHost, port, dbName, dbUser , dbPassword);
    }
    ...
    @Bean
    public StocService stocService() {
        StocService mc = new StocService();
        mc.setStocDAO(stocDAO());
        return mc;
    }
