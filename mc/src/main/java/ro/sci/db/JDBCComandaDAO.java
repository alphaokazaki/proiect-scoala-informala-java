...
public class JDBCComandaDAO implements ComandaDAO {
    ...
    public Comanda getIdComanda(int aOrB, int idTable) {
       if (String.valueOf(aOrB).equals(String.valueOf(1)))
            ...
            try (   Connection connection = newConnection();
                ...
                {
                    throw new RuntimeException("Nu sa putut generea un numar de comanda!", ex);
                }
                return result;
            } else {
            ...
            throw new RuntimeException("Nu sa putut deduce daca exista o comanda deschisa!", ex);
        }
        return result;}
    }
    ...
    public Comanda countComenziDeschise(int idTable) {
        ...
        try (Connection connection = newConnection();
            ...
            throw new RuntimeException("Nu sa putut deduce daca exista comenzi deschise!", ex);
        }
        return result;
    }
    ...
    public void anulComanda(String idComenzi, int idTable) {
        ...
        try (Connection connection = newConnection();
            ...
            throw new RuntimeException("Nu s-au putut sterge produsele din comanda!", ex);
        }
        ...
        try (Connection connection = newConnection();
            ...
            throw new RuntimeException("Nu sa putut sterge antetul comenzii!", ex);
        }
    }
    ...
    public void finshComanda(String idComenzi, int idTable) {
        ...
        try (Connection connection = newConnection();
            ...
            throw new RuntimeException("Eroare la finalizarea comenzii!", ex);
        }
    }
    ...
    protected Connection newConnection() {
        try {
            ...
            throw new RuntimeException("Nu se gaseste conecxiune la Baza de Date!", ex);
        }
    }
