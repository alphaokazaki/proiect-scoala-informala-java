...
public class SmartMeniuControler {
    ...
    public ModelAndView stock() {
        ModelAndView result = new ModelAndView("/stock");
        Collection<Stoc> stoc = stocService.listAll();

        result.addObject("stoc", stoc);
    ...
    public ModelAndView accessDenied() {
        ModelAndView modelAndView = new ModelAndView("admin/denied");
